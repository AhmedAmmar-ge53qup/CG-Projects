...
"out vec4 fragColor;" // Outputting fragColor to screen
"void main()"
"{"
...
int main()
{
	...
	glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, 6 * sizeof(GL_FLOAT), (GLvoid*)0); // For Position
	glEnableVertexAttribArray(0);
	glVertexAttribPointer(1, 3, GL_FLOAT, GL_FALSE, 6 * sizeof(GL_FLOAT), (GLvoid*)(sizeof(GL_FLOAT)*3)); // For Color
