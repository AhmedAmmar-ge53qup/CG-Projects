...
// Global Variables
const char* APP_TITLE = "Computer Graphics - Hello Triangle with 2 VBOs";
...
"layout (location = 1) in vec3 color;"  // We receive this from the program (vertices array)
"out vec3 vertColor;" // Outputting Color to Fragment Shader
"void main()"
"{"
"	gl_Position = vec4(pos.x, pos.y, pos.z, 1.0);"
"	vertColor = color;"	// We assign the color we received from program
"}";

// Fragment Shader
const GLchar* fragmentShaderSource =
"#version 330 core\n"
"in vec3 vertColor;" // Receiving Color from Vertex Shader
...
int main()
{
	...
	glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, 0, nullptr); // For Position, as u can see cuz its tightly packed, we can give total size of 0
	glEnableVertexAttribArray(0);

	glBindBuffer(GL_ARRAY_BUFFER, VBO2);
	glVertexAttribPointer(1, 3, GL_FLOAT, GL_FALSE, 3 * sizeof(GL_FLOAT), (GLvoid*)0); // 3*sizeof(GL_FLOAT) can also be 0 cuz tightly packed
