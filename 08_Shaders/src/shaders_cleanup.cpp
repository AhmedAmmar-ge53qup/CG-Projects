...
// Global Variables
const char* APP_TITLE = "Computer Graphics - Reading Shaders from Files";
...
int main()
{
	...
	glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, 3 * sizeof(GLfloat), nullptr); // cuz its tightly packed, we can give stride size of 0
